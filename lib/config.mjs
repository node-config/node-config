...
// Dependencies
/** @typedef {import('./util.mjs').Util} Util */
/** @typedef {import('./util.mjs').Load} Load */
/** @typedef {import('./util.mjs').LoadOptions} LoadOptions */
/** @typedef {typeof import('../parser.mjs')} Parser */
import { Util, Load, RawConfig } from './util.mjs';
...
class ConfigUtils {
   ...
   * @return {import('./util.mjs').ConfigSource[]} configSources - An array of objects containing
