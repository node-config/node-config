 ...
 */
_.mixin({
  out: function(name, obj, deep, eyesConfig) {
 ...
 */
_.mixin({
  outStr: function(name, obj, deep, eyesConfig) {

    // Pass onto out(), with a null stream.  This returns the string.
    var config = _.extendDeep({}, eyesConfig ? eyesConfig : {}, {
          stream: null
        });
