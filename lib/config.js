 ...
 * by the file.  The search order is same as in extendFrom method.
 * </p>
 */
...
/**
 * Extends current config object from files in specified directory.
 *
 * <p>
 * This method builds a map of filename to the configuration object defined
 ...
 *
 * @method extendFrom 
 * @param dir {string} Path to directory with configuration files.
 * @return {this} The configuration object
 */
Config.prototype.extendFrom = function(dir) {
  var t = this;
  ...
  baseNames.forEach(function(baseName) {
    extNames.forEach(function(extName) {
      ...
      var fullFilename = dir + '/' + baseName + '.' + extName;
      ...
      if (appInstance) {
        fullFilename = dir + '/' + baseName + '-' + appInstance + '.' + extName;
