 ...
 *
 * <p>
 * This method allows you to reset the whole runtime.json generated file.
 * </p>
 *
 * @method resetRuntime
 * @return {boolean} TRUE if can reset file, FALSE if cant
 */
Config.prototype.resetRuntime = function() {
    try {
        FileSystem.writeFileSync(runtimeJsonFilename, '{}');
    } catch (e) {
        console.log("Cannot write runtime.json file " + e);
